...
- [ ] HPO: when changing HPO config schema, `run_hpo.py`, or trial behavior, update `HPO_SPEC.md`, `samples/hpo_config.yaml` (and `samples/config_sample_hpo.yaml` if pipeline template changes), and the README HPO subsection.
