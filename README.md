...
| **analysis.q_max_train / q_max_test**                          | Optional; `null` = use all (or fallback to `q_gen.max_train` / `q_gen.max_test` if present). Int = cap reference set for Q (gen and recon).                                                                                        |
